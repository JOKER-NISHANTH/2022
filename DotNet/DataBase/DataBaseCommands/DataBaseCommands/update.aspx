<%@ Page Language="C#" Inherits="DataBaseCommands.update" %>
...
<head runat="server">
	...
	<script runat="server">
      ...
      MySqlConnection con = new MySqlConnection ("server=localhost;database=cs;userid=root;password=gasc");
			con.Open ();
			MySqlCommand cmd =new MySqlCommand("UPDATE  firstmca SET  name='"+name.Text+"', marks ='"+marks.Text+"' WHERE rno='"+roll.Text+"'",con);
			int i = cmd.ExecuteNonQuery();
			if (i == 1) {
			l.Text = "Record Update";
			}
			else {
			l.Text = "Error";
			}
...
<body>
	...
	<asp:Button id="b" runat="server" OnClick="b1c " Text="Update Data" />
