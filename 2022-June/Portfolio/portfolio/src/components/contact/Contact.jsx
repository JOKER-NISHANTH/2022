...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_raz7mmu', 'U6e3Nk1FbSEc1_tCS', form.current, 'U6e3Nk1FbSEc1_tCS')
    e.target.reset()
      .then((result) => {
    ...
    <section id="contact">
      ...
      <article className="contact__option">
          ...
          <article className="contact__option">
            ...
            <h4>WhatsApp</h4>
            <h5>+1234567890</h5>
            <a href="https://api.whatsapp.com/send?phone=+919715079782" target="_blank" rel="noreferrer" >Ping Me</a>
          </article>
